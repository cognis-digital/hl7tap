#!/usr/bin/env sh
# Universal installer for hl7tap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/hl7tap.git"
echo "Installing hl7tap ..."
