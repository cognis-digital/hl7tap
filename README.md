...
[![PyPI](https://img.shields.io/pypi/v/cognis-hl7tap.svg)](https://pypi.org/project/cognis-hl7tap/)
[![CI](https://github.com/cognis-digital/hl7tap/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/hl7tap/actions)
...
HL7TAP exists for one job — parse, pretty-print, diff, and replay hl7 v2 messages over mllp from the terminal. — and does it without a SaaS bill or heavyweight setup.
...
```bash
hl7tap --version
hl7tap scan .                      # scan the current project
hl7tap scan . --format json
hl7tap scan . --fail-on high       # non-zero exit for CI gates
hl7tap mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **HAPI HL7v2 + tcpreplay**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`hl7tap` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
